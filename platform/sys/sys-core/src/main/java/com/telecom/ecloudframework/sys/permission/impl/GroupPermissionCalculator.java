...
import com.telecom.ecloudframework.base.core.util.ThreadMapUtil;
...
public abstract class GroupPermissionCalculator implements IPermissionCalculator {
	 ...
	 */
	private static String threadMapKey = "com.telecom.ecloudframework.sys.permission.impl.GroupPermission";
