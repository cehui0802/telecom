...
import com.telecom.ecloudframework.sys.core.dao.SysAuthorizationDao;
...
public class SysAuthorizationManagerImpl extends BaseManager<String, SysAuthorization> implements SysAuthorizationManager {
    ...
    public Map<String, Object> getUserRightsSql(RightsObjectConstants rightsObject, String userId, String targetKey) {
        ...
        sb.insert(0, "inner join sys_authorization rights on " + targetKey + " = rights.rights_target_  and  rights.rights_object_ ='" + rightsObject.key() + "' and rights.rights_permission_code_ in ( ");
        sb.append(")");
