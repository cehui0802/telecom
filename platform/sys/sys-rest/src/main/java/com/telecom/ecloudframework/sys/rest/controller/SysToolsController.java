...
import com.telecom.ecloudframework.base.core.util.ConstantUtil;
import com.telecom.ecloudframework.base.core.util.EnumUtil;
import com.telecom.ecloudframework.base.core.util.HanyuPinyinHelper;
...
public class SysToolsController extends ControllerTools {
	 ...
	 * 注意！！如果枚举在类中间，那么路径如下：com.telecom.ecloudframework.base.db.model.Column$TYPE
	 * </pre>
	 *
	 * @param request
	 * @param response
...
//		classPath = "com.telecom.ecloudframework.bpm.engine.plugin.context.AbstractBpmPluginContext";
	...
	@CatchErr
	@RequestMapping("getSysProperty")
	public ResultMsg<String> getSysProperty(@RequestParam String alias) {
		String str = SysPropertyUtil.getByAlias(alias, "");
