 ...
 *
 * <pre>
 * <bean id="dataSource" class="com.telecom.ecloudframework.base.db.datasource.DynamicDataSource">
...
public class DynamicDataSource extends AbstractRoutingDataSource {
    ...
    //因为父类的targetDataSources属性是private的子类如果想引用这个父类的属性就必须要用反射的方式获取对象
