package com.telecom.ecloudframework.base.db.dboper;
 ...
 * </pre>
 */
public class KingBaseDbOperator extends DbOperator {
    ...
    public Map<String, String> getTableNames(String tableName) {
        ...
        for (Map<String, Object> m : list) {
            map.put(m.get("table_name").toString().toUpperCase(), getOrDefault(m, "comments", "").toString());
        }
    ...
    public Table<Column> getTable(String tableName) {
        ...
        if (tableNames.isEmpty()) {
            throw new BusinessException(tableName + BaseStatusCode.TABLE_NOT_FOUND.getDesc() ,BaseStatusCode.TABLE_NOT_FOUND);
        }
    ...
    public Table<Column> getView(String viewName) {
        ...
        if (viewNames.isEmpty()) {
            throw new BusinessException(BaseStatusCode.VIEW_NOT_FOUND);
        }
    ...
    private List<Column> getColumns(String name) {
        ...
        for (Map<String, Object> map : listT) {
            pkNames.add(getOrDefault(map, "COLUMN_NAME", "").toString().toUpperCase());
        }
...
//		String sql = "ALTER TABLE " + tableName.toUpperCase() + " ADD PARTITION P_" + partName.toUpperCase() + " VALUES ( '" + partName + "') NOCOMPRESS ";
        String sql = "ALTER TABLE " + tableName.toUpperCase() + " ADD PARTITION P_" + partName.toUpperCase() + " VALUES ( '" + partName + "')";
