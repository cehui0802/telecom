...
import com.telecom.ecloudframework.base.core.ext.IEnumExtraDataLoader;
...
public class EnumUtil {
     ...
     * 前端调用例子：
     * <%@page import="cn.gwssi.ecloudframework.sys.persistence.enums.FieldControlType"%>
     * <%@page import="cn.gwssi.ecloudframework.base.core.util.EnumUtil"%>
    ...
    public static JSONArray toJSONArray(Class<? extends Enum<?>> enumClass, String tag) {
        try {
            ...
            Enum<?>[] enums = (Enum[]) method.invoke(enumClass, tag);
            JSONArray jsonArray = new JSONArray(enums.length);
            for (Enum<?> e : enums) {
                jsonArray.add(toJSON(e));
            }
     ...
     * <pre>
     * 把一个枚举类的路径转成json数组
     * 注意！！如果枚举在类中间，那么路径如下：cn.gwssi.ecloudframework.base.db.model.Column$TYPE
     * </pre>
     *
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(EnumUtil.toJSON("cn.gwssi.ecloudframework.bus.api.constant.BusinessObjectPersistenceType"));
    }
}
